...
const mytmplt kModules[MAXMODULE] PROGMEM = {
  ...
  { "Shelly 1",         // Any ESP8266/ESP8285 device like WeMos and NodeMCU hardware (ESP8266)
     0,                 // GPIO00 
     0,                 // GPIO01 
     0,                 // GPIO02 
     0,                 // GPIO03 
     GPIO_REL1,         // GPIO04 Relay O and I
     GPIO_SWT1,         // GPIO05 SW pin
     0, 0, 0, 0, 0, 0,  // Flash connection
     0,                 // GPIO12 
     0,                 // GPIO13 
     0,                 // GPIO14 
  ...
  { "Shelly 2",         // Any ESP8266/ESP8285 device like WeMos and NodeMCU hardware (ESP8266)
     0,                 // GPIO00
     0,                 // GPIO01 
     0,                 // GPIO02
     0,                 // GPIO03
